...
export const createSubject = async (subjectData: CreateSubjectRequest): Promise<SubjectResponse> =>{
...
export const updateSuject = async(id:number, subjecData: CreateSubjectRequest): Promise<SubjectResponse> =>{
